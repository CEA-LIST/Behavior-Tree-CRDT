...
Behavior Tree is a simplified metamodel of a metalanguage, close to Ecore. It features concepts such as `class`, `attribute`, `datatype`, `package`, and `reference`.

![Behavior Tree Ecore metamodel](/behavior_tree.jpg "Behavior Tree's Ecore metamodel")
